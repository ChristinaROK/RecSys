...
from surprise import AlgoBase # AlgoBase 상속 받아서 customized algo 만들기
...
class ContentKNNAlgorithm(AlgoBase):
    ...
    def __init__(self, k=40, sim_options={}): # kNN의 'k'
    ...
    def computeGenreSimilarity(self, movie1, movie2, genres): # cosine similarity
    ...
    def computeMiseEnSceneSimilarity(self, movie1, movie2, mes):
        ...
        mes2 = mes[movie2]
        if (mes1 and mes2):
            shotLengthDiff = math.fabs(mes1[0] - mes2[0]) #math.fabs(): absolute value
